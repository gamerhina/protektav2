...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">Kelola Seminar</h1>
        ...
        <!-- Finished Seminars Table -->
        @if(isset($finishedSeminars) && $finishedSeminars->count() > 0)
            <div class="overflow-x-auto border border-gray-100 rounded-2xl shadow-sm">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        @foreach($finishedSeminars as $seminar)
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="flex gap-2">
                                    @if($nilai)
                                        <a href="{{ route('dosen.nilai.input', ['seminar' => $seminar->id]) }}" class="text-blue-600 hover:text-blue-800 font-semibold" title="Lihat Nilai">
            ...
            <div class="mt-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="w-full md:w-auto">
                    {{ $finishedSeminars->links('components.pagination') }}
                </div>
            </div>
        @else
            <div class="text-center py-8">
                <p class="text-gray-500">Tidak ada seminar yang selesai untuk dikelola.</p>
            </div>
        @endif
    </div>
</div>
