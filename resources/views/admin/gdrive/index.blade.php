                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm">
                            <div class="flex flex-wrap gap-3">
                                ...
                                <a href="{{ route('admin.gdrive.edit', $folder) }}" class="text-blue-600 hover:text-blue-800 font-semibold" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('admin.gdrive.destroy', $folder) }}" method="POST" class="inline"
