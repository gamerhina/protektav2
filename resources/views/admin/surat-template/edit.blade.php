    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            ...
            <p class="text-slate-500 mt-1 flex items-center gap-2">
                <i class="fas fa-magic text-indigo-500"></i> Modern HTML Template Editor for <strong>{{ $suratJenis->nama }}</strong>
            </p>
        </div>
        <div class="flex items-center gap-3">
            ...
            <button type="button" id="btn-save-master" class="px-6 py-2.5 rounded-xl bg-indigo-600 text-white font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 hover:-translate-y-0.5 transition-all flex items-center gap-2">
                <i class="fas fa-check"></i> Simpan Template
            </button>
        </div>
    </div>

    <form id="master-form" method="POST" action="{{ route('admin.surat-template.update', [$suratJenis, $template]) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="form-group lg:col-span-1">
                        ...
                        @if($template->header_image_path)
                            <div class="mb-4 relative group max-w-md rounded-2xl overflow-hidden border border-slate-100 bg-slate-50 p-2">
                                <img src="{{ Storage::url($template->header_image_path) }}" class="w-full h-auto rounded-xl shadow-sm" alt="Current Header">
                                <div class="mt-2 flex items-center justify-between">
                                    <span class="text-[9px] text-slate-400 font-bold uppercase">Current Header</span>
                                    <label class="flex items-center gap-1.5 text-[9px] text-red-500 font-bold cursor-pointer hover:text-red-600 transition-all">
                    ...
                    <div class="form-group lg:col-span-1">
                        ...
                        <select name="header_visibility" id="header_visibility" class="w-full px-4 py-2 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-indigo-50 focus:border-indigo-500 transition-all text-sm font-semibold bg-white cursor-pointer appearance-none shadow-sm">
