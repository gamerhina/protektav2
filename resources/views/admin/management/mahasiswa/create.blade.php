            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($dosens as $d)
                            <option value="{{ $d->id }}" {{ old('pembimbing_akademik_id') == $d->id ? 'selected' : '' }}>
                                {{ $d->nama }} (NIP: {{ $d->nip }})
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input
                            ...
                            required
                        >
                        <button type="button" class="toggle-password absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-600 focus:outline-none" data-target="password_confirmation">
                            <i class="fas fa-eye"></i>
                        </button>
                    </div>
                </div>
