...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">Import Data Dosen</h1>
        ...
        <div class="mb-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
            ...
            <ul class="list-disc pl-5 space-y-1 text-blue-700">
                ...
                <li>Kolom yang wajib diisi: <strong>Nama</strong>, <strong>NIP</strong>, dan <strong>Email</strong></li>
                ...
                <li>Data dosen dengan NIP yang sudah ada akan diperbarui</li>
                <li>Jika kolom Password kosong, maka password default akan menjadi NIP</li>
            </ul>
        </div>

        <div class="mb-6">
            <a href="{{ route('admin.dosen.sample.download') }}" class="btn-gradient inline-flex items-center gap-2" data-no-ajax>
