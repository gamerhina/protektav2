...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight mt-4">Tambah Role Baru</h1>
        <p class="text-slate-500 mt-1">Buat role baru untuk sistem persetujuan surat</p>
    </div>

    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
        <form action="{{ route('admin.surat-role.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="kode" 
                           ...
                           placeholder="Contoh: KAJUR"
                           required>
                    <p class="text-slate-500 text-sm mt-1">Gunakan huruf kapital tanpa spasi</p>
                    @error('kode')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="3"
                              class="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-50 focus:border-indigo-500 transition-all @error('deskripsi') border-red-500 @enderror"
